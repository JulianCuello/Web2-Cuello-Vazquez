                ...
                <?php foreach($categorias as $item) { ?>      
                    <tr>
                        ...
                        <td><a href="categoryId/<?php echo $item->idCategoria; ?>" class="btn btn-primary">Productos relacionados</a>
                            <a href="removeCategory/<?php echo $item->idCategoria; ?>" type="button" class='btn btn-danger ml-auto'>Eliminar</a>
                            <a href="formCategoryUpdate/<?php echo $item->idCategoria; ?>" type="button" class='btn btn-success ml-auto'>Modificar</a>
                        </td>
                    </tr>      
                <?php } ?>
            </tbody>
